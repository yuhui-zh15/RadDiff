...
data:
  root: ./application/survival_analysis/mortality_vs_hospital_datasets
  name: {dataset_name}
  group1: "{item['set1']}"
  group2: "{item['set2']}"
  purity: {purity}
...
@click.option("--dataset", default="pneumonia_30_day_death_vs_long_survived.jsonl", type=str, help="Dataset JSONL file name")
